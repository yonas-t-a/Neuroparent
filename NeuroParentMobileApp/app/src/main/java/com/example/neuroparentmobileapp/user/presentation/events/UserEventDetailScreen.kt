...
@Composable
fun UserEventDetailScreen(navController: NavController) {
        ...
        Column(
            ...
            Button(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .height(48.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color(0xFFD58787)) // Light blue
            ) {
...
fun EventDetailCard() {
    Card(
        ...
        Column(modifier = Modifier.padding(16.dp)) {
            EventDetailsRow("Date", "April 20, 2025")
            Spacer(modifier = Modifier.height(8.dp))
            EventDetailsRow("Time", "7:00 pm")
            Spacer(modifier = Modifier.height(8.dp))
            EventDetailsRow("Location", "Room H-12,\nHilton Hotel,\nAddis Ababa,\nEthiopia")
        }
    }
}

@Composable
fun EventDetailsRow(label: String, value: String) {
    Row {
